...
# docker build -t reactionview_bootstrap .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name reactionview_bootstrap reactionview_bootstrap
